...
import urllib.parse,sys,urllib.request,urllib.parse,urllib.error
    ...
    try:
        ...
        for p in ['title','year','imdb','tvdb','season','episode','tvshowtitle','premiered','select']:
            if rtype == "show" and p == "tvshowtitle":
                try: r += '&'+p+'='+urllib.parse.quote_plus(rlist[rand]['title'])
                except: pass
            else:
                try: r += '&'+p+'='+urllib.parse.quote_plus(rlist[rand][p])
                except: pass
        try: r += '&meta='+urllib.parse.quote_plus(json.dumps(rlist[rand]))
        except: r += '&meta='+urllib.parse.quote_plus("{}")
        if rtype == "movie":
